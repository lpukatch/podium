...
export const FIELDS: FieldSpec[] = [
  ...
  },
  {
    ...
    help: 'Watches Dispatcharr’s live sessions and records which stream served, for how long, and when it failed over.',
  ...
  },
  {
    ...
    help: 'How often live sessions are sampled. A stream that drops faster than this is never seen holding at all.',
  ...
  },
  {
    ...
    help: 'e.g. “03:00-06:00”. Leave empty to never soak automatically. Ranges that cross midnight are fine.',
  ...
  },
  {
    ...
    help: 'How long each soak holds its stream open.',
  ...
  },
  {
    ...
    help: 'How deep into each channel’s order the sweep measures. 0 measures every matched stream.',
  ...
  },
  {
    ...
    help: 'A stream observed more recently than this is left alone by the sweep.',
  ...
  },
  {
    ...
    help: 'How long a soak slot waits after a connection closes before opening another.',
  ...
  },
  {
    ...
    help: 'Per account. Soaks never run an account at its full limit, so there is room for a viewer and for the provider’s own accounting.',
  ...
  },
  {
    ...
    help: 'Identifies proxy-mode probes so Podium does not count them as viewers.',
    section: 'probing',
  },
  {
